...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Religion_Master))
        ...
        Me.lbl_Freeze.Location = New System.Drawing.Point(112, 240)
        Me.lbl_Freeze.Name = "lbl_Freeze"
        Me.lbl_Freeze.Size = New System.Drawing.Size(380, 27)
        ...
        Me.Lbl_SerName.Location = New System.Drawing.Point(120, 176)
        ...
        Me.KeyPreview = True
        Me.Name = "Religion_Master"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Religion_Master"
...
#End Region
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        If Cmd_Add.Text = "Add[F7]" Then
            ...
            sqlstring = "Insert into Tbl_ReligionMaster"
            ...
            gconnection.dataOperation(1, sqlstring, "Tbl_ReligionMaster")
        ...
        ElseIf Cmd_Add.Text = "Update[F5]" Then
            ...
            If Mid(Me.Cmd_Add.Text, 1, 1) = "U" Then
                ...
                End If
            End If
            sqlstring = "Update Tbl_ReligionMaster SET "
            ...
            gconnection.dataOperation(2, sqlstring, "Tbl_ReligionMaster")
    ...
    Private Sub Cmd_Freeze_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Freeze.Click
        ...
        Else
            ...
            sqlstring = sqlstring & " WHERE Code = '" & Trim(Txtcode.Text) & "'"
            gconnection.dataOperation(4, sqlstring, "Tbl_ReligionMaster")
    ...
    Private Sub Cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_View.Click
        ...
        tables = " FROM Tbl_ReligionMaster"
        Gheader = "RELIGION MASTER VIEW"
    ...
    Private Sub Cmd_Clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Clear.Click
        ...
        Txtcode.Focus()
    End Sub
    'Private Sub Religion_Master_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    '    End If
    'End Sub
    Private Sub Religion_Master_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ServerMastbool = True
        If gUserCategory <> "S" Then
            Call GetRights()
        End If
    ...
    Private Sub Religion_Master_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        End Try
    End Sub
    Private Sub Religion_Master_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    Private Sub cmdRankMasterHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMasterHelp.Click
        ...
        gSQLString = "SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME  FROM Tbl_ReligionMaster "
        If Trim(Search) = " " Then
            M_WhereCondition = ""
        Else
            M_WhereCondition = ""
        ...
        Dim ssql As String
        ssql = " Select Freeze  From Tbl_ReligionMaster Where Code='" & Txtcode.Text & "'"
    ...
    Private Sub Txtcode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txtcode.Validated
        Try
            ...
            If Txtcode.Text <> "" Then
                Sqlstr = " SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME,ISNULL(Romancatholic,'') AS Romancatholic,ISNULL(FREEZE,'N') AS FREEZE,ISNULL(ADDDATETIME,'') AS ADDDATETIME  FROM Tbl_ReligionMaster  WHERE CODE='" & Trim(Txtcode.Text) & "'"
