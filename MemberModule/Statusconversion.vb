...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Statusconversion))
        ...
        Me.cmd_MemberCodeHelp.Location = New System.Drawing.Point(320, 96)
        ...
        Me.lbl_Remarks.Location = New System.Drawing.Point(72, 280)
        ...
        Me.txt_Remarks.Location = New System.Drawing.Point(136, 96)
        ...
        Me.lbl_Effectivefrom.Location = New System.Drawing.Point(72, 360)
        ...
        Me.lbl_NewStatus.Location = New System.Drawing.Point(72, 243)
        ...
        Me.lbl_PresentStatus.Location = New System.Drawing.Point(72, 206)
        ...
        Me.txt_PresentStatus.Location = New System.Drawing.Point(200, 208)
        ...
        Me.dtp_EffectiveFrom.Location = New System.Drawing.Point(200, 360)
        ...
        Me.cbo_NewStatus.Items.AddRange(New Object() {"ACTIVE", "INACTIVE", "EXPIRED", "DEFAULTER", "ABSENTEE", "SUSPENDED", "TERMINATED", "CEASED"})
        Me.cbo_NewStatus.Location = New System.Drawing.Point(200, 243)
        ...
        Me.lbl_MemberCode.Location = New System.Drawing.Point(72, 96)
        ...
        Me.lbl_MemberName.Location = New System.Drawing.Point(360, 96)
        ...
        Me.txt_MemberName.Location = New System.Drawing.Point(480, 96)
        ...
        Me.Label1.Location = New System.Drawing.Point(40, 520)
        ...
        Me.cmd_ListView.Location = New System.Drawing.Point(216, 472)
        ...
        Me.cmd_Delete.Location = New System.Drawing.Point(328, 472)
        ...
        Me.cmd_AddNew.Location = New System.Drawing.Point(104, 472)
        ...
        Me.txt_MemberCode.Location = New System.Drawing.Point(200, 96)
        ...
        Me.grp_StatusConversion2.Font = New System.Drawing.Font("Verdana", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.grp_StatusConversion2.Location = New System.Drawing.Point(64, 184)
        Me.grp_StatusConversion2.Name = "grp_StatusConversion2"
        Me.grp_StatusConversion2.Size = New System.Drawing.Size(656, 144)
        ...
        Me.grp_StatusConversion3.Location = New System.Drawing.Point(64, 336)
        Me.grp_StatusConversion3.Name = "grp_StatusConversion3"
        Me.grp_StatusConversion3.Size = New System.Drawing.Size(656, 64)
        ...
        Me.Grp_Print.Controls.Add(Me.Button1)
        ...
        Me.Grp_Print.Location = New System.Drawing.Point(171, 392)
        ...
        Me.ClientSize = New System.Drawing.Size(782, 556)
...
#End Region
    ...
    Dim SqlString, ssql, TERMINATED, ter As String
    Dim gconnection As New GlobalClass
    Private Sub Statusconversion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmd_AddNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_AddNew.Click
        Try
            'MessageBox.Show(gUsername)
            Dim pstatus, nstatus, status As String
            If (txt_PresentStatus.Text = "TERMINATED") Or (txt_PresentStatus.Text = "EXPIRED") Then
                If TERMINATED = "Y" Then
                    If MessageBox.Show("Terminated member can not be altered to any other status. Would you still like to go ahead  (Y)es / (N)o ", MyCompanyName, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
                        ter = "N"
                        Exit Sub
                    Else
                        ter = "Y"
                ...
                Else
                        TERMINATED = "N"
                        MessageBox.Show("You have not rights to Terminate/Expired this member", MyCompanyName, MessageBoxButtons.AbortRetryIgnore)
                        Exit Sub
                    End If
            ...
            If cmd_AddNew.Text = "Add New[F5]" Then
                ...
                SqlString = SqlString & Trim(txt_MemberName.Text) & "','" & Trim(pstatus) & "','" & Trim(nstatus) & "','" & Trim(txt_Remarks.Text) & "',"
                ...
                If (txt_PresentStatus.Text = "TERMINATED") Or (txt_PresentStatus.Text = "EXPIRED") Then
                    SqlString = " UPDATE membermaster SET TERMINATION='' WHERE MCODE='" & txt_MemberCode.Text & "'"
                    gconnection.dataOperation(2, SqlString, "Memberledger")
                End If
                If (cbo_NewStatus.Text = "TERMINATED") Or (cbo_NewStatus.Text = "EXPIRED") Then
                    SqlString = " UPDATE membermaster SET TERMINATION='Y' WHERE MCODE='" & txt_MemberCode.Text & "'"
                    gconnection.dataOperation(2, SqlString, "Memberledger")
                End If
                SqlString = "insert into memdet(MEM_CODE,type0,type1,start_dt,end_dt,remarks)"
                SqlString = SqlString & "values('" & txt_MemberCode.Text & "','STAT','" & Mid(Trim(cbo_NewStatus.Text), 1, 1) & "',Convert(datetime,'" & (dtp_EffectiveFrom.Text) & "',103),Convert(datetime,'" & (dtp_EffectiveTo.Text) & "',103),'" & txt_Remarks.Text & "')"
                gconnection.dataOperation(2, SqlString, "Memberledger")
    ...
    Public Sub ledger()
        ...
        'Dim r As New Cry_ledger
        'ssql = "SELECT * FROM MEMBERmaster"
        'Call Viewer.GetDetails1(ssql, "memberledger", r)
    ...
    Private Sub CMD_WINDOWS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMD_WINDOWS.Click
        ...
        Dim r As New Cry_ledger
        SqlString = "SELECT * FROM MEMBERLEDGER"
        Call Viewer.GetDetails1(SqlString, "MEMBERLEDGER", r)
        'txtobj1 = r.ReportDefinition.ReportObjects("Text6")
        'txtobj1.Text = UCase(gCompanyname)
