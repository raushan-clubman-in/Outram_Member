...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Button1.Location = New System.Drawing.Point(560, 616)
...
#End Region
    ...
    Private Sub Btn_ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_ok.Click
        ...
        Dim monthly, month1, year, day As String
        monthly = Month(Format(dtp_year.Value, "dd/MMM/yyyy"))
        month1 = Format(dtp_year.Value, "MM")
        year = Format(dtp_year.Value, "yyyy")
        day = Format(dtp_year.Value, "dd")
        year1 = Convert.ToInt16(year)
        If month1 = "01" Then
            If day < "31" Then
                MessageBox.Show("Invalid Posting Date", gCompanyname)
                Exit Sub
            End If
        End If
        If month1 = "02" Then
    ...
    Private Sub dtp_year_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtp_year.ValueChanged
