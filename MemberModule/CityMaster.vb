...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Citymaster))
        ...
        Me.lbl_Freeze.Location = New System.Drawing.Point(176, 288)
        ...
        Me.Lbl_SerName.Location = New System.Drawing.Point(184, 160)
        Me.Lbl_SerName.Name = "Lbl_SerName"
        Me.Lbl_SerName.Size = New System.Drawing.Size(45, 18)
        Me.Lbl_SerName.TabIndex = 428
        Me.Lbl_SerName.Text = "CITY:"
        '
        'Label1
        '
        ...
        Me.Cbo_PCountry.Location = New System.Drawing.Point(248, 240)
        Me.Cbo_PCountry.Name = "Cbo_PCountry"
        Me.Cbo_PCountry.Size = New System.Drawing.Size(248, 23)
        Me.Cbo_PCountry.TabIndex = 824
        '
        'Cbo_PState
        '
        ...
        Me.Cbo_PState.Location = New System.Drawing.Point(248, 200)
        Me.Cbo_PState.Name = "Cbo_PState"
        Me.Cbo_PState.Size = New System.Drawing.Size(248, 23)
...
#End Region
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        ...
        ElseIf Cmd_Add.Text = "Update[F7]" Then
            ...
            sqlstring = sqlstring + "Name='" + Trim(txtName.Text) + "',State ='" + Trim(Cbo_PState.Text) + "',country ='" + Trim(Cbo_PCountry.Text) + "',Freeze= 'N',Adduser='" & gUsername & " ', Adddatetime='" & Format(Now, "dd-MMM-yyyy hh:mm:ss") & "' Where Code='" + Trim(Txtcode.Text) + "'"
    ...
    Private Sub Cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_View.Click
        ...
        FrReport.SsGridReport.SetText(2, 3, "STATE")
        FrReport.SsGridReport.SetText(3, 3, 25)
        FrReport.SsGridReport.SetText(2, 4, "COUNTRY")
    ...
    Private Sub Cmd_Clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Clear.Click
        ...
        Txtcode.Focus()
    End Sub
    'Private Sub RankMaster_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    '    End If
    'End Sub
    Private Sub RankMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ServerMastbool = True
        If gUserCategory <> "S" Then
            Call GetRights()
        End If
    ...
    Private Sub RankMaster_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        End Try
    End Sub
    Private Sub RankMaster_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    Private Sub cmdRankMasterHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMasterHelp.Click
        ...
        Else
            M_WhereCondition = ""
        End If
        vform.Field = "CODE,NAME,STATE"
        vform.vFormatstring = "  CODE    |   NAME                                   |STATE                                        | COUNTRY                                 "
        ...
        If Trim(vform.keyfield & "") <> "" Then
            ...
            'Txt_state.Text = Trim(vform.keyfield2 & "")
            'Txt_country.Text = Trim(vform.keyfield3 & "")
            Cbo_PState.Text = Trim(vform.keyfield2 & "")
            Cbo_PCountry.Text = Trim(vform.keyfield3 & "")
        ...
        Dim ssql As String
        ssql = " Select Freeze  From Tbl_CityMaster Where Code='" & Txtcode.Text & "'"
    ...
    Private Sub Txtcode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txtcode.Validated
        Try
            ...
            If Txtcode.Text <> "" Then
                Sqlstr = " SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME,ISNULL(STATE,'') AS STATE,ISNULL(COUNTRY,'') AS COUNTRY,ISNULL(FREEZE,'') AS FREEZE,ISNULL(ADDDATETIME,'') AS ADDDATETIME FROM Tbl_CityMaster WHERE CODE='" & Trim(Txtcode.Text) & "'"
