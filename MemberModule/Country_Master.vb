...
#End Region
    ...
    Private Sub Cmd_Clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Clear.Click
        ...
        Txtcode.Focus()
    End Sub
    'Private Sub Country_Master_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub Country_Master_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        End Try
    End Sub
    Private Sub Country_Master_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    Private Sub cmdRankMasterHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMasterHelp.Click
        ...
        gSQLString = "SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME  FROM Tbl_CountryMaster "
        If Trim(Search) = " " Then
            M_WhereCondition = ""
        Else
            M_WhereCondition = ""
        ...
        Dim ssql As String
        ssql = " Select Freeze  From Tbl_CountryMaster Where Code='" & Txtcode.Text & "'"
    ...
    Private Sub Txtcode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txtcode.Validated
        ...
        '    If Txtcode.Text <> "" Then
        '        Sqlstr = " SELECT ISNULL(NAME,'') AS NAME  FROM Tbl_countrymaster WHERE CODE='" & Trim(Txtcode.Text) & "'"
        ...
        '            'Cbo_Pstate.Text = gdataset.Tables("Master").Rows(0).Item("COUNTRY")
        '            Me.Cmd_Add.Text = "Update[F7]"
        '        Else
        '            txtName.Text = ""
        '        End If
        ...
        Try
            ...
            If Txtcode.Text <> "" Then
                Sqlstr = " SELECT ISNULL(NAME,'') AS NAME,ISNULL(FREEZE,'N') AS FREEZE,ISNULL(ADDDATETIME,'') AS ADDDATETIME  FROM Tbl_countrymaster  WHERE CODE='" & Trim(Txtcode.Text) & "'"
                gconnection.getDataSet(Sqlstr, "Master")
                If gdataset.Tables("Master").Rows.Count > 0 Then
                    Txtcode.ReadOnly = True
                    txtName.Text = gdataset.Tables("Master").Rows(0).Item("Name")
    ...
    Private Sub Country_Master_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
