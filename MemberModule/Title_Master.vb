...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Title_Master))
        ...
        Me.lbl_Freeze.Location = New System.Drawing.Point(160, 248)
        ...
        Me.KeyPreview = True
        Me.Name = "Title_Master"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Title_Master"
...
#End Region
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        ...
        ElseIf Cmd_Add.Text = "Update[F7]" Then
            ...
            gconnection.dataOperation(2, sqlstring, "Tbl_TitleMaster")
    ...
    Private Sub Cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_View.Click
        ...
        Gheader = "SALUTATION MASTER VIEW"
    ...
    Private Sub cmdRankMasterHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMasterHelp.Click
        ...
        Dim ssql As String
        ssql = " Select Freeze  From Tbl_TitleMaster Where Code='" & Txtcode.Text & "'"
    ...
    Private Sub Txtcode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txtcode.Validated
        Try
            ...
            If Txtcode.Text <> "" Then
                Sqlstr = " SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME,ISNULL(FREEZE,'N') AS FREEZE,ISNULL(ADDDATETIME,'') AS ADDDATETIME  FROM Tbl_TitleMaster  WHERE CODE='" & Trim(Txtcode.Text) & "'"
