Imports System.Data
Public Class MaritalStatus_Master
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(MaritalStatus_Master))
        ...
        Me.Chk_yes.Location = New System.Drawing.Point(544, 8)
        Me.Chk_yes.Name = "Chk_yes"
        Me.Chk_yes.Size = New System.Drawing.Size(44, 24)
        Me.Chk_yes.TabIndex = 689
        Me.Chk_yes.Text = "Yes"
        Me.Chk_yes.Visible = False
        '
        'lbl_Freeze
        '
        ...
        Me.lbl_Freeze.Location = New System.Drawing.Point(144, 240)
        Me.lbl_Freeze.Name = "lbl_Freeze"
        Me.lbl_Freeze.Size = New System.Drawing.Size(376, 27)
        Me.lbl_Freeze.TabIndex = 691
        Me.lbl_Freeze.Text = "Record Freezed  On "
        Me.lbl_Freeze.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
        Me.lbl_Freeze.Visible = False
        '
        'MaritalStatus_Master
        '
        ...
        Me.KeyPreview = True
        Me.Name = "MaritalStatus_Master"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "MaritalStatus_Master"
...
#End Region
    ...
    Private Sub Cmd_Freeze_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Freeze.Click
        ...
        If Mid(Me.Cmd_Freeze.Text, 1, 1) = "F" Then
            ...
            gconnection.dataOperation(3, sqlstring, "Tbl_MaritalStatusMaster")
        ...
        Else
            ...
            sqlstring = sqlstring & " WHERE Code = '" & Trim(Txtcode.Text) & "'"
            gconnection.dataOperation(4, sqlstring, "Tbl_MaritalStatusMaster")
    ...
    Private Sub Cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_View.Click
        ...
        Gheader = "MARITAL STATUS MASTER VIEW"
    ...
    Private Sub cmdRankMasterHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMasterHelp.Click
        ...
        Dim ssql As String
        ssql = " Select Freeze  From Tbl_MaritalStatusMaster Where Code='" & Txtcode.Text & "'"
    ...
    Private Sub Txtcode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txtcode.Validated
        Try
            ...
            If Txtcode.Text <> "" Then
                Sqlstr = " SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME,ISNULL(FREEZE,'N') AS FREEZE,ISNULL(ADDDATETIME,'') AS ADDDATETIME  FROM Tbl_MaritalStatusMaster  WHERE CODE='" & Trim(Txtcode.Text) & "'"
