...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(State_Master))
        ...
        Me.lbl_Freeze.Location = New System.Drawing.Point(168, 288)
        Me.lbl_Freeze.Name = "lbl_Freeze"
        Me.lbl_Freeze.Size = New System.Drawing.Size(376, 27)
        ...
        Me.Lbl_SerName.Location = New System.Drawing.Point(176, 168)
        Me.Lbl_SerName.Name = "Lbl_SerName"
        Me.Lbl_SerName.Size = New System.Drawing.Size(53, 18)
        Me.Lbl_SerName.TabIndex = 425
        Me.Lbl_SerName.Text = "STATE:"
        '
        'Label1
        '
        ...
        Me.txtName.Location = New System.Drawing.Point(248, 168)
        Me.txtName.MaxLength = 50
        Me.txtName.Name = "txtName"
        Me.txtName.Size = New System.Drawing.Size(248, 21)
        Me.txtName.TabIndex = 420
        Me.txtName.Text = ""
        '
        'Cbo_PCountry
        '
        ...
        Me.Cbo_PCountry.Location = New System.Drawing.Point(248, 216)
        Me.Cbo_PCountry.Name = "Cbo_PCountry"
        Me.Cbo_PCountry.Size = New System.Drawing.Size(248, 23)
...
#End Region
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        If Cmd_Add.Text = "Add[F7]" Then
            ...
            sqlstring = sqlstring + "values('" + Trim(Txtcode.Text) + "','" + Trim(txtName.Text) + "', 'N','" + Trim(Cbo_PCountry.Text) + "','" & gUsername & " ', '" & Format(Now, "dd-MMM-yyyy hh:mm:ss") & "')"
        ...
        ElseIf Cmd_Add.Text = "Update[F7]" Then
            ...
            sqlstring = sqlstring + "Name='" + Trim(txtName.Text) + "',Country ='" + Trim(Cbo_PCountry.Text) + "',Freeze= 'N',Adduser='" & gUsername & " ', Adddatetime='" & Format(Now, "dd-MMM-yyyy hh:mm:ss") & "' Where Code='" + Trim(Txtcode.Text) + "'"
    ...
    Private Sub Cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_View.Click
        ...
        FrReport.SsGridReport.SetText(2, 3, "COUNTRY")
    ...
    Private Sub Cmd_Clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Clear.Click
        ...
        Txtcode.Focus()
    End Sub
    'Private Sub State_Master_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub State_Master_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        End Try
    End Sub
    Private Sub State_Master_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    Private Sub cmdRankMasterHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMasterHelp.Click
        ...
        End If
        vform.Field = "NAME"
        vform.vFormatstring = "  CODE   |         NAME                                    |              COUNTRY               "
        ...
        If Trim(vform.keyfield & "") <> "" Then
            ...
            Cbo_PCountry.Text = Trim(vform.keyfield2 & "")
        ...
        Dim ssql As String
        ssql = " Select Freeze  From Tbl_StateMaster Where Code='" & Txtcode.Text & "'"
    ...
    Public Sub State()
        Dim i As Integer
        Dim dt As DataTable
        sqlstring = "SELECT distinct(NAME) FROM Tbl_COUNTRYMASTER where freeze<>'Y'"
    ...
    Private Sub Txtcode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Txtcode.Validated
        ...
        '    If Txtcode.Text <> "" Then
        '        Sqlstr = " SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME,ISNULL(COUNTRY,'') AS COUNTRY  FROM Tbl_stateMaster WHERE CODE='" & Trim(Txtcode.Text) & "'"
        ...
        Try
            ...
            If Txtcode.Text <> "" Then
                Sqlstr = " SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME,ISNULL(COUNTRY,'') AS COUNTRY,ISNULL(FREEZE,'') AS FREEZE,ISNULL(ADDDATETIME,'')AS ADDDATETIME  FROM Tbl_stateMaster WHERE CODE='" & Trim(Txtcode.Text) & "'"
                gconnection.getDataSet(Sqlstr, "Master")
                If gdataset.Tables("Master").Rows.Count > 0 Then
                    Txtcode.ReadOnly = True
                    txtName.Text = gdataset.Tables("Master").Rows(0).Item("Name")
