...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ReasonMaster))
        ...
        Me.txtName.Size = New System.Drawing.Size(352, 72)
...
#End Region
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        If Cmd_Add.Text = "Add[F7]" Then
            ...
            sqlstring = "Insert into ReasonMaster"
        ...
        ElseIf Cmd_Add.Text = "Update[F5]" Then
            ...
            If Mid(Me.Cmd_Add.Text, 1, 1) = "U" Then
                ...
                End If
            End If
            sqlstring = "Update ReasonMaster SET "
    ...
    Private Sub Cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_View.Click
        ...
        tables = " FROM ReasonMaster"
        Gheader = "REASON MASTER VIEW"
    ...
    Private Sub Cmd_Clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Clear.Click
        ...
        Txtcode.Focus()
    End Sub
    'Private Sub ReasonMaster_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    '    End If
    'End Sub
    Private Sub ReasonMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ServerMastbool = True
        If gUserCategory <> "S" Then
            Call GetRights()
        End If
    ...
    Private Sub ReasonMaster_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        End Try
    End Sub
    Private Sub ReasonMaster_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    Private Sub cmdRankMasterHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMasterHelp.Click
        ...
        gSQLString = "SELECT ISNULL(CODE,'') AS CODE,ISNULL(NAME,'') AS NAME  FROM ReasonMaster "
        If Trim(Search) = " " Then
            M_WhereCondition = ""
        Else
            M_WhereCondition = ""
        ...
        Dim ssql As String
        ssql = " Select Freeze  From ReasonMaster Where Code='" & Txtcode.Text & "'"
