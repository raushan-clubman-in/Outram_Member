...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Corpstatus))
        ...
        Me.Chk_Dojwisediff.Visible = False
        '
        'Chk_details
        '
        ...
        Me.rdb_date.Size = New System.Drawing.Size(168, 50)
        ...
        Me.rdb_all.Size = New System.Drawing.Size(64, 27)
        ...
        Me.Label1.Text = "INSTITUTIONAL REPORT"
        '
        'GroupBox2
        '
...
#End Region
    Private Sub Memberstatus_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ssql = "select isnull(CMcorporateCode,'') as CMcorporateCode,isnull(CMcorporateName,'') as CMcorporateName from CORPORATEMASTER"
        ...
        For Itration = 0 To (MEMBERTYPE.Rows.Count - 1)
            ...
            chk_Filter_Field.Items.Add(MEMBERTYPE.Rows(Itration).Item("CMcorporateName"))
        Next
    ...
    Public Sub Summary1()
        Try
            ...
            Dim r As New Cry_CorpStatusSummary
            SQL = "SELECT * FROM VW_MEMBERSTATUS_SUMMARY1"
            ...
            Viewer.ssql = SQL
            Viewer.Report = r
            Viewer.TableName = "VW_MEMBERSTATUS_SUMMARY1"
            Viewer.Show()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    ...
    Public Sub Member_Status_Details()
        Try
            Dim SQL, Company As String
            Dim Viewer As New ReportViwer
            Dim r As New Cry_corporate
            If (chk_Filter_Field.CheckedItems.Count <= 0) Then
                MessageBox.Show("Select Any Category Items")
                Exit Sub
                'ElseIf (chk_Filter_Field.CheckedItems.Count > 1) Then
                '    MessageBox.Show("Select One Category Items")
                '    Exit Sub
            End If
            SQL = "SELECT * FROM VIEW_CORPORATE"
            txtCategory.Text = ""
            txtStatus.Text = ""
            Dim o As Object
            For Each o In chk_Filter_Field.CheckedItems
            ...
            Next o
            Dim s As Object
            For Each s In chk_Filter_Field.CheckedItems
                Company = s.ToString()
            Next s
            ...
            Next j
            If (txtCategory.Text <> "") Then
                SQL = SQL & " where CMCORPORATENAME in (" & txtCategory.Text.Substring(0, txtCategory.Text.Length - 1) & ") and curentstatus in (" & txtStatus.Text.Substring(0, txtStatus.Text.Length - 1) & ")"
            End If


            SQL = SQL & " order by mcode Asc"
            'txtobj1 = r.ReportDefinition.ReportObjects("Text6")
            'txtobj1.Text = Company
            txtobj1 = r.ReportDefinition.ReportObjects("Text10")
            txtobj1.Text = UCase(gCompanyname)
            txtobj1 = r.ReportDefinition.ReportObjects("Text11")
            txtobj1.Text = UCase(gCompanyAddress(1))
            ...
            Viewer.ssql = SQL
            Viewer.Report = r
            Viewer.TableName = "VIEW_CORPORATE"
            Viewer.Show()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
