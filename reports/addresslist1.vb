                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    For j = 0 To 2
                        If i < dt.Rows.Count Then
                            ...
                            vMName(j) = Mid(Trim(dt.Rows(i).Item("prefix") & ""), 1, 40) & " " & Mid(Trim(dt.Rows(i).Item("mname") & ""), 1, 40)
                    ...
                    Filewrite.WriteLine(Mid(vMCode(0), 1, 30) & Space(30 - Len(Mid(vMCode(0), 1, 30))) & Space(28) & Mid(vMCode(1), 1, 30) & Space(30 - Len(Mid(vMCode(1), 1, 30))) & Space(36) & Mid(vMCode(2), 1, 30) & Space(30 - Len(Mid(vMCode(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMName(0), 1, 30) & Space(30 - Len(Mid(vMName(0), 1, 30))) & Space(28) & Mid(vMName(1), 1, 30) & Space(30 - Len(Mid(vMName(1), 1, 30))) & Space(36) & Mid(vMName(2), 1, 30) & Space(30 - Len(Mid(vMName(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMAdd1(0), 1, 30) & Space(30 - Len(Mid(vMAdd1(0), 1, 30))) & Space(28) & Mid(vMAdd1(1), 1, 30) & Space(30 - Len(Mid(vMAdd1(1), 1, 30))) & Space(36) & Mid(vMAdd1(2), 1, 30) & Space(30 - Len(Mid(vMAdd1(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMAdd2(0), 1, 30) & Space(30 - Len(Mid(vMAdd2(0), 1, 30))) & Space(28) & Mid(vMAdd2(1), 1, 30) & Space(30 - Len(Mid(vMAdd2(1), 1, 30))) & Space(36) & Mid(vMAdd2(2), 1, 30) & Space(30 - Len(Mid(vMAdd2(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMAdd3(0), 1, 30) & Space(30 - Len(Mid(vMAdd3(0), 1, 30))) & Space(28) & Mid(vMAdd3(1), 1, 30) & Space(30 - Len(Mid(vMAdd3(1), 1, 30))) & Space(36) & Mid(vMAdd3(2), 1, 30) & Space(30 - Len(Mid(vMAdd3(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMCity(0), 1, 30) & Space(30 - Len(Mid(vMCity(0), 1, 30))) & Space(28) & Mid(vMCity(1), 1, 30) & Space(30 - Len(Mid(vMCity(1), 1, 30))) & Space(36) & Mid(vMCity(2), 1, 30) & Space(30 - Len(Mid(vMCity(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine()
                    Filewrite.WriteLine()
                    'Filewrite.WriteLine()
