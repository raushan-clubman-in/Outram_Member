...
Imports System.IO
Friend Class FRMOUTSTANDINGRPT_ROOM_Room
...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRMOUTSTANDINGRPT_ROOM_Room))
        ...
        Me.Label4.Text = "OUTSTANDING  SUMMARY ROOM"
        '
        'Label10
        '
        ...
        Me.Name = "FRMOUTSTANDINGRPT_Room"
        Me.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "ROOM OUTSTANDING REPORT"
        Me.ResumeLayout(False)

    End Sub
#End Region
#Region "Upgrade Support "
    Private Shared m_vb6FormDefInstance As FRMOUTSTANDINGRPT_ROOM_Room
    Private Shared m_InitializingDefInstance As Boolean
    Public Shared Property DefInstance() As FRMOUTSTANDINGRPT_ROOM_Room
        Get
            If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_vb6FormDefInstance = New FRMOUTSTANDINGRPT_ROOM_Room
                m_InitializingDefInstance = False
            End If
            DefInstance = m_vb6FormDefInstance
        End Get
        Set(ByVal Value As FRMOUTSTANDINGRPT_ROOM_Room)
...
#End Region
    ...
    Private Sub PrintOperation()
        ...
        Try
            ...
            Dim dd As Date
            dd = Now()
            vCaption = "ROOM RENT OUTSTANDING DETAILS AS ON :" & IIf(Month(cbxMonth.Value) = Month(dd), Format(dd, "dd/MMM/yyyy"), Format(DTPASONDATE1.Value, "dd/MMM/yyyy"))
            vSql = " EXEC TP_OUTSTANDING_SUMMARY_ROOM  " & "'" & Format(DTPASONDATE1.Value, "dd-MMM-yyyy") & "','" & Format(cbxMonth.Value, "dd-MMM-yyyy") & "'"
            ...
            Filewrite.WriteLine("Room Rent Oustanding Reports as on :" & Trim(mdate) & Space(10) & "Page No:" & Trim(CStr(vpageNo)))
    ...
    Private Sub OPTALL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles OPTALL.Click
        ...
        End If
    End Sub
    Private Sub FRMOUTSTANDINGRPT_ROOM_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        End If
    End Sub
    Private Sub FRMOUTSTANDINGRPT_ROOM_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub FRMOUTSTANDINGRPT_ROOM_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Leave
