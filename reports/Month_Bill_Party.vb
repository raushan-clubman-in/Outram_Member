...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Month_Bill_PARTY))
        ...
        Me.Chk_Members_List.Font = New System.Drawing.Font("Arial", 12.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.Chk_Members_List.Location = New System.Drawing.Point(944, 184)
        Me.Chk_Members_List.Name = "Chk_Members_List"
        Me.Chk_Members_List.Size = New System.Drawing.Size(252, 298)
        Me.Chk_Members_List.Sorted = True
        Me.Chk_Members_List.TabIndex = 429
        ...
        Me.chk_PrintAll.Location = New System.Drawing.Point(408, 152)
        Me.chk_PrintAll.Name = "chk_PrintAll"
        Me.chk_PrintAll.Size = New System.Drawing.Size(185, 23)
        Me.chk_PrintAll.TabIndex = 428
        ...
        Me.Label1.Location = New System.Drawing.Point(400, 48)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(173, 35)
        Me.Label1.TabIndex = 426
        Me.Label1.Text = "PARTY BILL"
        '
        'Chk_SelectAllMember
        '
        ...
        Me.chk_Filter_Field.Location = New System.Drawing.Point(312, 184)
        Me.chk_Filter_Field.Name = "chk_Filter_Field"
        Me.chk_Filter_Field.Size = New System.Drawing.Size(376, 277)
        Me.chk_Filter_Field.Sorted = True
        Me.chk_Filter_Field.TabIndex = 427
        '
        'Label10
        '
        ...
        Me.CbxMonth.Location = New System.Drawing.Point(528, 108)
        Me.CbxMonth.Name = "CbxMonth"
        Me.CbxMonth.Size = New System.Drawing.Size(112, 26)
        Me.CbxMonth.TabIndex = 433
        '
        'GroupBox2
        '
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(104, 552)
        ...
        Me.Label7.Location = New System.Drawing.Point(320, 480)
        ...
        Me.Label8.Location = New System.Drawing.Point(520, 480)
        ...
        Me.tbx_filter_To.Location = New System.Drawing.Point(546, 480)
        Me.tbx_filter_To.Name = "tbx_filter_To"
        Me.tbx_filter_To.Size = New System.Drawing.Size(80, 20)
        Me.tbx_filter_To.TabIndex = 436
        ...
        Me.tbx_Filter_From.Location = New System.Drawing.Point(365, 480)
        Me.tbx_Filter_From.Name = "tbx_Filter_From"
        Me.tbx_Filter_From.Size = New System.Drawing.Size(80, 20)
        Me.tbx_Filter_From.TabIndex = 435
        Me.tbx_Filter_From.Text = ""
        '
        'CHK_TMP
        '
        Me.CHK_TMP.Font = New System.Drawing.Font("Microsoft Sans Serif", 12.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.CHK_TMP.Location = New System.Drawing.Point(304, 520)
        Me.CHK_TMP.Name = "CHK_TMP"
        Me.CHK_TMP.Size = New System.Drawing.Size(304, 24)
        Me.CHK_TMP.TabIndex = 441
        Me.CHK_TMP.Text = "WITH OUT TEMPORARY MEMBER "
        '
        'CHK_SUMMARY
        '
        Me.CHK_SUMMARY.Font = New System.Drawing.Font("Microsoft Sans Serif", 12.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.CHK_SUMMARY.Location = New System.Drawing.Point(616, 520)
        Me.CHK_SUMMARY.Name = "CHK_SUMMARY"
        Me.CHK_SUMMARY.Size = New System.Drawing.Size(304, 24)
        Me.CHK_SUMMARY.TabIndex = 441
        ...
        Me.Controls.Add(Me.Chk_Members_List)
        Me.Controls.Add(Me.chk_PrintAll)
        Me.Controls.Add(Me.Label1)
        Me.Controls.Add(Me.Chk_SelectAllMember)
        Me.Controls.Add(Me.chk_Filter_Field)
        Me.Controls.Add(Me.CHK_SUMMARY)
        Me.Name = "Month_Bill_PARTY"
        Me.Text = "Month_Bill_PARTY"
...
#End Region
    Private Sub Month_Bill_PARTY_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call FILLTYPE()
    ...
    Function Bill_Print()
        Try
            ...
            If tbx_Filter_From.Text <> "" And tbx_filter_To.Text <> "" Then
                ...
                Sqlstring = Sqlstring & " view_openingbalance_net_party B WHERE A.MCODE=B.SLCODE AND B.AMOUNT<>0 "
            ...
            vdate1 = Format(CbxMonth.Value, "dd/MMM/yyyy")
            ...
            If gdataset.Tables("MMASTER").Rows.Count > 0 Then
                For i = 0 To gdataset.Tables("MMASTER").Rows.Count - 1
                    ...
                    Filewrite.WriteLine()
                    Filewrite.WriteLine()
                    Filewrite.WriteLine(Space(35) & "PARTY BILL" & Space(20) & Now.Date)
                    Filewrite.WriteLine()
                    Filewrite.WriteLine(Mid(Trim(gdataset.Tables("MMASTER").Rows(i).Item("slcode") & ""), 1, 47) & Space(47 - Len(Mid(Trim(gdataset.Tables("MMASTER").Rows(i).Item("slcode") & ""), 1, 47))) & "MADRAS CLUB")
                    Filewrite.WriteLine(Mid(Trim(gdataset.Tables("MMASTER").Rows(i).Item("slname") & ""), 1, 47) & Space(47 - Len(Mid(Trim(gdataset.Tables("MMASTER").Rows(i).Item("slname") & ""), 1, 47))) & "No.8, ADYAR CLUB GATE ROAD")
                    ...
                    vrow = vrow + 17
                    Sqlstring = " select isnull(sum(dramount)- sum(cramount),0) as amount from view_openingbalance_party "
                    Sqlstring = Sqlstring & " where voucherdate<'" & vdate1 & "' and slcode='" & Trim(gdataset.Tables("MMASTER").Rows(i).Item("slcode") & "'" & "")
    ...
    Function Bill_Print_SUMMARY()
        Try
            ...
            Filewrite.WriteLine("MADRAS CLUB")
            Filewrite.WriteLine("No.8, ADYAR CLUB GATE ROAD")
            Filewrite.WriteLine("Chennai-600028")
            Filewrite.WriteLine("Party Bill Summary   :" & Format(CbxMonth.Value, "dd/MM/yyyy"))
            Filewrite.WriteLine(StrDup(83, "="))
            Filewrite.WriteLine("Sno          Description                                      Amount")
            Filewrite.WriteLine(StrDup(83, "="))
            Sqlstring = " Select isnull(sum(A.dramount)- sum(A.cramount),0) as amount from view_openingbalance_party A ,MEMBERMASTER B"
            Sqlstring = Sqlstring & " where A.voucherdate<'" & vdate1 & "' and  A.SLCODE=B.MCODE AND " & ssql
            gconnection.getDataSet(Sqlstring, "OPL")
            If gdataset.Tables("OPL").Rows.Count > 0 Then
                vmemopbal = gdataset.Tables("OPL").Rows(0).Item("AMOUNT")
            Else
            ...
            End If
            Sqlstring = "select isnull(sum(A.amount),0) as amount from Month_Bill_PARTY A, MEMBERMASTER B where  A.voucherdate>='" & vdate1 & "' AND A.SLCODE=B.MCODE "
