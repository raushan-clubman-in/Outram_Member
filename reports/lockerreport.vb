...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(lockerreport))
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(208, 499)
        ...
        Me.Label1.Text = "LOCKER NUMBER LIST"
        '
        'tbx_Filter_From
        '
        ...
        Me.cmb_Filter_By.Location = New System.Drawing.Point(264, 8)
        ...
        Me.Label9.Location = New System.Drawing.Point(104, 8)
        ...
        Me.Label10.Location = New System.Drawing.Point(784, 144)
        ...
        Me.Cmb_add_filter.Location = New System.Drawing.Point(768, 160)
        ...
        Me.KeyPreview = True
        Me.Name = "lockerreport"
        Me.Text = "lockerreport"
...
#End Region
    ...
    Private Sub lockerlist()
        ...
        Try
            ...
            End If
            FinalString = "select MCODE,MNAME,CurentStatus,HPLocker,GDRLocker,LDRLocker from membermaster where (hplocker <> '' or gdrlocker <> '' or ldrlocker <> '' )"
            FinalString = FinalString & " and membertypecode in ('" & addFltrStr & "') and curentstatus in('" & status & "')"
            ...
            If Len(DispString) <= 67 Then
                Filewrite.WriteLine(Chr(27) + "E" & "LOCKER NUMBER WISE :" & Trim(DispString) & Chr(27) + "F")
                pagesize = pagesize + 1
            Else
                Filewrite.Write(Chr(27) + "E" & "LOCKER NUMBER WISE :")
                j = 0
                For i = 1 To Len(Trim(DispString))
                    If j = 0 Then
                        Filewrite.WriteLine(Mid(Trim(DispString), 1, 67))
                        pagesize = pagesize + 1
                        i = i + 66
                    Else
                        Filewrite.WriteLine(Mid(Trim(DispString), i, 90))
                        pagesize = pagesize + 1
                        i = i + 89
                    End If
                    j = j + 1
            ...
            Filewrite.WriteLine("|SNo |CODE     |NAME                                   |STATUS   |HPL    |GDRL   |LDRL   |")
            Filewrite.WriteLine(StrDup(90, "-"))
            pagesize = pagesize + 4
            SNO = 1
            For row = 0 To addlist.Rows.Count - 1
                ...
                STR2 = (addlist.Rows(row).Item("mname"))
                STR3 = Mid((addlist.Rows(row).Item("curentstatus")), 1, 9)
                STR4 = IIf((addlist.Rows(row).Item("HPLOCKER")) <> "", (addlist.Rows(row).Item("HPLOCKER")), " - ")
                STR5 = IIf((addlist.Rows(row).Item("GDRLOCKER")) <> "", (addlist.Rows(row).Item("GDRLOCKER")), " - ")
                STR6 = IIf((addlist.Rows(row).Item("LDRLOCKER")) <> "", (addlist.Rows(row).Item("LDRLOCKER")), " - ")
                Filewrite.WriteLine("{0,-5}{1,-10}{2,-40}{3,-10}{4,-8}{5,-8}{6,-8}{7,1}", "|" & SNO, "|" & STR1, "|" & STR2, "|" & STR3, "|" & STR4, "|" & STR5, "|" & STR6, "|")
                SNO = SNO + 1
                pagesize = pagesize + 1
            Next row
            SNO = SNO - 1
            Filewrite.WriteLine(StrDup(90, "-"))
            Filewrite.Write("NO OF LOCKER LIST = " & Trim(CStr(SNO)) & Space(5) & "USER NAME: " & gUsername & Space(15) & "DATE :" & Format(Date.Now, "dd/MM/yyyy") & Chr(12))
            Filewrite.Close()
