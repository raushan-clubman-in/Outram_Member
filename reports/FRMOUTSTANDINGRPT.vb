...
Imports System.IO
Friend Class FRMOUTSTANDINGRPT
...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRMOUTSTANDINGRPT))
        ...
        Me.cbxMonth.Location = New System.Drawing.Point(296, 88)
        Me.cbxMonth.Name = "cbxMonth"
        Me.cbxMonth.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.cbxMonth.Size = New System.Drawing.Size(144, 21)
        ...
        Me.Label5.Location = New System.Drawing.Point(232, 240)
        ...
        Me.Label2.Location = New System.Drawing.Point(120, 240)
        ...
        Me.Shape2.Size = New System.Drawing.Size(512, 256)
        ...
        Me.Label4.Text = "OUTSTANDING   SUMMARY"
        '
        'Label10
        '
        ...
        'DTPASONDATE1
        '
        Me.DTPASONDATE1.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.DTPASONDATE1.Size = New System.Drawing.Size(144, 21)
        ...
        Me.Label8.Location = New System.Drawing.Point(456, 184)
        ...
        Me.OUTSTD_LST.Location = New System.Drawing.Point(448, 184)
        ...
        Me.Label9.Location = New System.Drawing.Point(424, 240)
        ...
        Me.GRP1.Location = New System.Drawing.Point(16, 40)
        Me.GRP1.Name = "GRP1"
        Me.GRP1.Size = New System.Drawing.Size(696, 504)
        ...
        Me.GRP_EXIT.Location = New System.Drawing.Point(160, 448)
        ...
        Me.EXCLEXPORT.Location = New System.Drawing.Point(360, 448)
        ...
        Me.AxfpSpread1.Location = New System.Drawing.Point(32, 16)
        ...
        Me.AxfpSpread1.Size = New System.Drawing.Size(640, 424)
        Me.AxfpSpread1.TabIndex = 616
        '
        'ChkDOS
        '
        Me.ChkDOS.BackColor = System.Drawing.Color.Transparent
        Me.ChkDOS.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
...
#End Region
        ...
        Try
            ...
            If Val(txtamount.Text) > 0 Then
                ...
                ElseIf OPTSTATUS.Checked = True Then
                    ...
                    If txtamount.Text = "" Then
                        vSql = "select mcode,SLname,clbal from outstandrpt_summary where MCODE IN (SELECT MCODE FROM MEMBERMASTER WHERE CURENTSTATUS='" & CMBTYPE.Text & "') AND CLBAL<>0  ORDER BY MCODE"
                    Else
                        vSql = "select mcode,SLname,clbal from outstandrpt_summary where  MCODE IN (SELECT MCODE FROM MEMBERMASTER WHERE CURENTSTATUS='" & CMBTYPE.Text & "') AND CLBAL>= " & Format(Val(txtamount.Text), "0.00") & "  ORDER BY MCODE"
                    End If
            ...
            Else
                ...
                ElseIf OPTSTATUS.Checked = True Then
                    ...
                    If txtamount.Text = "" Then
                        vSql = "select mcode,SLname,clbal from outstandrpt_summary where MCODE IN (SELECT MCODE FROM MEMBERMASTER WHERE CURENTSTATUS='" & CMBTYPE.Text & "') AND CLBAL<>0  ORDER BY MCODE"
                    Else
                        vSql = "select mcode,SLname,clbal from outstandrpt_summary where  MCODE IN (SELECT MCODE FROM MEMBERMASTER WHERE CURENTSTATUS='" & CMBTYPE.Text & "')   and isnull(clbal,0) <> 0  ORDER BY MCODE"
                    End If
                End If
    ...
    Private Sub PRINTOUTSTANDOPERATION()
        ...
        Try
            ...
            'Else
            '    If OPTALL.Checked = True Then
            vSql = "select mcode,SLname,OpAmountbal,PayAmount,receiptAmt,Closingbal from outstandrpt_summary_list where Closingbal >= 10000 and type not in('AFC') ORDER BY MCODE"
