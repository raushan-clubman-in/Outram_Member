...
Public Class Cry_MemberStatusSummary
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_MemberStatusSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MemberStatusSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MemberStatusSummary = New Cry_MemberStatusSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
