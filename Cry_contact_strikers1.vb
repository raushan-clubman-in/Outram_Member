...
Public Class Cry_contact_strikers
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_contact_strikers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_contact_strikers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_contact_strikers = New Cry_contact_strikers
        rpt.Site = Me.Site
        Return rpt
    End Function
