...
Public Class Statusconversion1
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Statusconversion1))
        ...
        Me.cmd_MemberCodeHelp.Location = New System.Drawing.Point(272, 56)
        ...
        Me.lbl_Remarks.Location = New System.Drawing.Point(32, 192)
        ...
        Me.lbl_Effectivefrom.Location = New System.Drawing.Point(32, 240)
        ...
        Me.lbl_NewStatus.Location = New System.Drawing.Point(32, 144)
        ...
        Me.lbl_PresentStatus.Location = New System.Drawing.Point(32, 104)
        ...
        Me.txt_PresentStatus.Location = New System.Drawing.Point(152, 104)
        ...
        Me.dtp_EffectiveFrom.Location = New System.Drawing.Point(152, 240)
        ...
        Me.cbo_NewStatus.Location = New System.Drawing.Point(152, 144)
        ...
        Me.lbl_MemberCode.Location = New System.Drawing.Point(32, 56)
        ...
        Me.lbl_MemberName.Location = New System.Drawing.Point(304, 56)
        ...
        Me.txt_MemberName.Location = New System.Drawing.Point(424, 56)
        ...
        Me.cmd_Exit.Location = New System.Drawing.Point(440, 360)
        ...
        Me.cmd_Clear.Location = New System.Drawing.Point(328, 360)
        ...
        Me.cmd_ListView.Location = New System.Drawing.Point(216, 360)
        ...
        Me.cmd_Delete.Location = New System.Drawing.Point(544, 400)
        ...
        Me.cmd_AddNew.Location = New System.Drawing.Point(104, 360)
        ...
        Me.txt_MemberCode.Location = New System.Drawing.Point(152, 56)
        ...
        Me.Cbo_reasons.Location = New System.Drawing.Point(152, 192)
        Me.Cbo_reasons.Name = "Cbo_reasons"
        Me.Cbo_reasons.Size = New System.Drawing.Size(392, 27)
        Me.Cbo_reasons.TabIndex = 709
        '
        'Label2
        '
        ...
        Me.Label2.Text = "MEMBERSHIP STATUSCONVERSION"
        '
        'Statusconversion1
        '
        ...
        Me.KeyPreview = True
        Me.Name = "Statusconversion1"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "MEMBERSHIP STATUSCONVERSION"
...
#End Region
    ...
    Private Sub cmd_AddNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_AddNew.Click
        ...
        Try
            ...
            If cmd_AddNew.Text = "Add New[F5]" Then
                ...
                End If
                SqlString = "insert into memdet(MEM_CODE,type0,type1,start_dt,end_dt,remarks)"
                SqlString = SqlString & "values('" & txt_MemberCode.Text & "','STAT','" & Mid(Trim(cbo_NewStatus.Text), 1, 1) & "',Convert(datetime,'" & (dtp_EffectiveFrom.Text) & "',103),Convert(datetime,'" & (dtp_EffectiveTo.Text) & "',103),'" & Trim(Cbo_reasons.Text) & "')"
                gconnection.dataOperation(2, SqlString, "Memberledger")
            ...
            ElseIf cmd_AddNew.Text = "Update[F5]" Then
                ...
                Dim SQLSTRING2 As String
                If boolchk = False Then Exit Sub
                SQLSTRING1 = "insert into Memberledger (MCODE,MNAME,NEWSTATUS,PRESENTSTATUS,REMARKS,EFFECTIVEFROM,EFFECTIVETO,USERID,ADDDATE) values('" & txt_MemberCode.Text & "','" & Trim(txt_MemberName.Text) & "','" & cbo_NewStatus.Text & "','" & txt_PresentStatus.Text & "','" & Trim(Cbo_reasons.Text) & "',Convert(datetime,'" & (dtp_EffectiveFrom.Text) & "',103),Convert(datetime,'" & (dtp_EffectiveTo.Text) & "',103),'" & gUsername & "',getdate())"
                SQLSTRING2 = " UPDATE membermaster SET CurentStatus='" & Trim(nstatus) & "',StatusDateFrom=Convert(datetime,'" & (dtp_EffectiveFrom.Text) & "',103),StatusDateTo=Convert(datetime,'" & (dtp_EffectiveTo.Text) & "',103) WHERE MCODE='" & txt_MemberCode.Text & "'"
    ...
    Private Sub cmd_ListView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_ListView.Click
        ...
        Gheader = "STATUS CONVERSION LIST"
        ...
        FrReport.SsGridReport.SetText(2, 3, "NEWSTATUS")
        FrReport.SsGridReport.SetText(3, 3, 15)
        FrReport.SsGridReport.SetText(2, 4, "PRESENTSTATUS")
        FrReport.SsGridReport.SetText(3, 4, 17)
        FrReport.SsGridReport.SetText(2, 5, "REMARKS")
        FrReport.SsGridReport.SetText(3, 5, 31)
        FrReport.SsGridReport.SetText(2, 6, "EFFECTIVEFROM")
        FrReport.SsGridReport.SetText(3, 6, 15)
        'FrReport.SsGridReport.SetText(2, 7, "EFFECTIVETO")
    ...
    Private Sub txt_MemberCode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_MemberCode.Validated
        Try
            ...
            'ElSE
                ...
                txt_PresentStatus.Text = Statusconv.Rows(0).Item("curentstatus")
    ...
    Public Sub Status()
        Dim i As Integer
        Dim dt As DataTable
        SqlString = "SELECT distinct(name) FROM MemberStatusMaster where freeze<>'Y'and isnull(STATUS,'')<>''  "
        dt = gconnection.GetValues(SqlString)
        Dim Itration
        For Itration = 0 To (dt.Rows.Count - 1)
