...
Public Class MemberTransfer
    ...
    Dim opcredit, opdebit, closingbal, cldebit, clcredit As Double
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents opbal As System.Windows.Forms.Label
    Friend WithEvents Label8 As System.Windows.Forms.Label
    Friend WithEvents clbal As System.Windows.Forms.Label
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.opbal = New System.Windows.Forms.Label
        Me.Label8 = New System.Windows.Forms.Label
        Me.clbal = New System.Windows.Forms.Label
        ...
        Me.Label1.Location = New System.Drawing.Point(368, 96)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(125, 22)
        Me.Label1.TabIndex = 749
        Me.Label1.Text = "Opening Bal:"
        '
        'opbal
        '
        Me.opbal.BackColor = System.Drawing.Color.Transparent
        Me.opbal.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.opbal.ForeColor = System.Drawing.Color.Black
        Me.opbal.Location = New System.Drawing.Point(488, 96)
        Me.opbal.Name = "opbal"
        Me.opbal.Size = New System.Drawing.Size(128, 20)
        Me.opbal.TabIndex = 750
        '
        'Label8
        '
        ...
        Me.Label8.Location = New System.Drawing.Point(368, 136)
        Me.Label8.Name = "Label8"
        Me.Label8.Size = New System.Drawing.Size(125, 22)
        Me.Label8.TabIndex = 751
        Me.Label8.Text = "Closing Bal:"
        '
        'clbal
        '
        Me.clbal.BackColor = System.Drawing.Color.Transparent
        Me.clbal.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.clbal.ForeColor = System.Drawing.Color.Black
        Me.clbal.Location = New System.Drawing.Point(496, 136)
        Me.clbal.Name = "clbal"
        Me.clbal.Size = New System.Drawing.Size(128, 20)
        Me.clbal.TabIndex = 752
        '
        'MemberTransfer
        '
...
#End Region
    ...
    Private Sub membertype()
        ...
        Try
            ...
            ssql = "SELECT ISNULL(SUBTypeCODE,'')AS MEMBERTYPE,ISNULL(SUBTypeDesc,'') AS TYPEDESC FROM SUBCATEGORYMASTER WHERE SUBTYPECODE<>'" & oldtype & "' AND ISNULL(FREEZE,'') <> 'Y' "
    ...
    Private Sub txtmembercode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtmembercode.Validated
        ...
        Try
            If Trim(txtmembercode.Text) <> "" Then
                sqlstring = "SELECT MCODE,MNAME,Curentstatus FROM MEMBERMASTER WHERE MCODE='" & Trim(txtmembercode.Text) & "' AND Curentstatus IN ('ACTIVE','LIVE')"
                ...
                sqlstring2 = "SELECT ISNULL(OPDEBITS,0) AS OPDEBITS,ISNULL(OPCREDITS,0) AS OPCREDITS,SUM(DEBIT)-SUM(CREDIT)AS CLOSING,A.slcode FROM OPENINGBAL,ACCOUNTSSUBLEDGERMASTER A where a.slcode=OPENINGBAL.slcode and A.SLCODE='" & Trim(txtmembercode.Text) & "' AND A.accode ='SDRS' GROUP BY A.SLCODE,opdebits,opcredits"
                gconnection.getDataSet(sqlstring2, "OPCL")
                If gdataset.Tables("OPCL").Rows.Count > 0 Then
                    Label1.Visible = True
                    Label8.Visible = True
                    opbal.Text = ""
                    clbal.Text = ""
                    opdebit = Val(gdataset.Tables("OPCL").Rows(0).Item("OPDEBITS"))
                    opcredit = Val(gdataset.Tables("OPCL").Rows(0).Item("OPCREDITS"))
                    closingbal = Val(gdataset.Tables("OPCL").Rows(0).Item("CLOSING"))
                End If
                clbal.Text = closingbal
                If opdebit > 0 Then
                    opbal.Text = opdebit
                Else
                    opbal.Text = opcredit
                ...
                If closingbal > 0 Then
                    cldebit = closingbal
                    clcredit = 0.0
                ElseIf closingbal < 0 Then
                    cldebit = 0.0
                    clcredit = closingbal / -1
                Else
                    cldebit = 0.0
                    clcredit = 0.0
                End If
    ...
    Private Sub cmdadd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdadd.Click
        ...
        If cmdadd.Text = "Update[F5]" Then
            Dim membername, status, sqlString, ssql2, ssql3 As String
            Call validate1()
            ...
            If gdataset.Tables("Temp").Rows.Count > 0 Then
                ...
                Else
                    ...
                    INSERT(INSERT.Length - 1) = sqlString
                End If
                sqlString = "INSERT INTO MEMBER_TRANSFER(OMCODE,NMCODE,OTYPE,NTYPE,OPDEBITS,OPCREDITS,CLDEBITS,CLCREDITS,ADDUSERID,ADDDATETIME,OSTATUS,NSTATUS,EFFECTFROM,REASON)VALUES('" & txtmembercode.Text & "','" & Txt_Newmember.Text & "','" & oldmembertype.Text & "','" & commembertype.Text & "'," & opdebit & "," & opcredit & "," & cldebit & "," & clcredit & ",'" & gUsername & "','" & Format(Now, "yyyy-MM-dd") & "', '" & txt_PresentStatus.Text & "','" & cbo_NewStatus.Text & "','" & Format(CDate(dtpdate.Text), "yyyy-MM-dd") & "','" & txtreason.Text & "')"
                'datalist = gconnection.GetValues(ssql)
                ReDim Preserve INSERT(INSERT.Length)
                INSERT(INSERT.Length - 1) = sqlString
                ...
                'datalist = gconnection.GetValues(ssql)
                ''ssql = "INSERT INTO TR_JOURNALENTRY(VoucherNo,VoucherDate,VoucherCategory,VoucherType,CashBank,CREDITDEBIT,AccountCode,AccountcodeDesc,SLCODE,SLDesc,CostCenterCode,CostCenterDesc,Amount,Description,InstrumentDate,InstrumentType,Instrumentno,BankName,BankPlace,OppAccountCode,OPPSLCODE,Void,ReceiptNo,Party_Name,ReceivedFrom,receiveddate,ref_no,REF_DATE,ROOMNO,SECTIONCODE,TDSPERC,TERMINATION,PARTYNAME,MICR,TAXTYPE,TAXCODE,BATCHNO,ADDUSERID,ADDDATETIME,FREEZEUSERID,FREEZEDATETIME,QUATERDATE,REALISEDDATE,POSTINGFLAG,QTY,TAXAMT,BTAXAMT,STAXCODE,TAXPER,TAXFLAG,UPDATEFLAG,SLCODE1,ADJUSTEDAMOUNT)"
                'ssql = ssql & " SELECT VoucherNo,VoucherDate,VoucherCategory,VoucherType,CashBank,CREDITDEBIT,AccountCode,AccountcodeDesc,'" & Txt_Newmember.Text & "',SLDesc,CostCenterCode,CostCenterDesc,Amount,Description,InstrumentDate,InstrumentType,Instrumentno,BankName,BankPlace,OppAccountCode,OPPSLCODE,Void,ReceiptNo,Party_Name,ReceivedFrom,receiveddate,ref_no,REF_DATE,ROOMNO,SECTIONCODE,TDSPERC,TERMINATION,PARTYNAME,MICR,TAXTYPE,TAXCODE,BATCHNO,ADDUSERID,ADDDATETIME,FREEZEUSERID,FREEZEDATETIME,QUATERDATE,REALISEDDATE,POSTINGFLAG,QTY,TAXAMT,BTAXAMT,STAXCODE,TAXPER,TAXFLAG,UPDATEFLAG,SLCODE1,ADJUSTEDAMOUNT FROM JOURNALENTRY WHERE SLCODE='" & txtmembercode.Text & "' AND ISNULL(VOID,'')<>'Y'"
                'datalist = gconnection.GetValues(ssql)
                ...
                'ssql3 = "update membermaster set CATLIMIT=(SELECT ISNULL(CREDITLIMIT,0) FROM SUBCATEGORYMASTER WHERE MEMBERMASTER.MEMBERTYPECODE=SUBTYPECODE)   where mcode='" & Txt_Newmember.Text & "' AND ISNULL(CATLIMIT,0)<>ISNULL(MEMLIMIT,0)"
                'datalist = gconnection.GetValues(ssql3)
                sqlString = "insert into membertypeconversion(Mcode,OMembertype,CMembertype,Effectfrom,Reason) values('" & txtmembercode.Text & "','" & oldmembertype.Text & "','" & commembertype.Text & "','" & Format(CDate(dtpdate.Text), "yyyy-MM-dd") & "', '" & txtreason.Text & "')"
                'datalist1 = gconnection.GetValues(sqlString)
                ReDim Preserve INSERT(INSERT.Length)
                INSERT(INSERT.Length - 1) = sqlString
            ...
            Else
                ...
                datalist = gconnection.GetValues(ssql)
                ssql = "INSERT into membermaster(SEQUENCENO,TAG,MEMBERTYPECODE,COMPANY,SUBCD,MCODE,MNAME,MID,DOB,DOJ,SEX,MARITALSTATUS,SPOUSE,BG,OCCUPATION,BANKER,BANKACNO,HOBBIES,OTHERINFO,RESIDENT,EQUALIFICATION,PQUALIFICATION,PROPOSER,PROPOSERNAME,SECONDER,SECONDERNAME,PAcopyst,PADD1,PADD2,PADD3,PCITY,PSTATE,PCOUNTRY,PPIN,PPHONE1,PPHONE2,PCELL,PEMAIL,RAcopyst,CADD1,CADD2,CADD3,CCITY,CSTATE,CCOUNTRY,CPIN,CPHONE1,CPHONE2,CCELL,CEMAIL,CONTADD1,CONTADD2,CONTADD3,CONTCITY,CONTSTATE,CONTCOUNTRY,CONTPIN,CONTPHONE1,CONTPHONE2,CONTCELL,CONTEMAIL,EMPTYPE,BUSINESSNAME,BAcopyst,OADD1,OADD2,OADD3,OCITY,OSTATE,OCOUNTRY,OPIN,OPHONE1,OPHONE2,OCELL,OEMAIL,DOEPROFESSION,BUSINESSNATURE,POSITIONHELD,SERVICENAME,SERVICEYEAR,PANO,BBANKER,CCNO,ANNUALINCOME,UPDUSERID,UPDDATETIME,TERMINATION,TRN_CON_DATE,CON_MCODE,PFAX,CFAX,CONTFAX,REASON,PHOTO,CREDITLIMIT,LIMITAMOUNT,WEBSITE,Imagefile,sizefield,Vdate,Vyear,Validdate,TempTermination,TempTermDate,TempTermReason,Memberid,EndingDate,TotalYears,CardNo,CardExpDate,Validity,Period,Creditcardno,CreditExpDt,Type,STATUSDATEFROM,STATUSDATETO,CurentStatus,FirstName,MiddleName,Surname,Alias,Prefix,BillType,Nationality,NationalityAtbirth,Billbasis,BillHead,GDRLocker,LDRLocker,HPLocker,MembershipTo,salut,EntranceFee,DevelopmentFee,CriditNumber,SecurityDeposit,PlaceOfBirth,CountryOfBirth,LastArrivalInCal,PeriodOfStay_year,PeriodOfStay_Month,PreviouslyProposed,NoOfTimesProposed,DateOfProposal,NoOfTimesSeconded,DateOfSeconded,ResultOfProposal,Elected,FatherName,DOBfather,WifeDOB,MaidenNameWife,NationalityWife,WifesFatherName,WifeFatherDOB,ApplNo,ApplDate,Corporatest,CorporateCode,CompName,Designation,ProfessionInfo,BuisnessInfo,Products,AgentsDealers,ESTDdate,NoOfEmp,Turnover,Client,AppliedBut,PositionInChamber,Qulificationstatus,Qualification1,Details1,YearOfPassing1,Institute1,Division1,Qualification2,Details2,YearOfPassing2,Institute2,Division2,Qualification3,Details3,YearOfPassing3,Institute3,Division3,sportstatus,GameType1,NameOfGame1,Description1,GameType2,NameofGame2,Description2,GameType3,NameOfGame3,Description3,Childstatus,ChildName1,ChildDob1,ChildSex1,ChildExpairy1,ChildName2,ChildDob2,ChildSex2,ChildExpairy2,ChildName3,ChildDob3,ChildSex3,childExpairy3,Clubstatus,OtherClubName1,OCAddress1,OCStatus1,OtherClubName2,OCAddress2,OCStatus2,OtherClubname3,OCAddress3,OCStataus,adduser,adddate,freeze,Relativestatus,RelativeName1,Relation1,dateofbirth1,Relativeage1,RelativeSex1,Relativeaddress1,RelativeName2,Relation2,dateofbirth2,Relativeage2,RelativeSex2,Relativeaddress2,RelativeName3,Relation3,dateofbirth3,Relativeage3,RelativeSex3,Relativeaddress3,referentialst,mem_code1,mem_name1,refmem_date1,deleted1,mem_code2,mem_name2,refmem_date2,deleted2,mem_code3,mem_name3,refmem_date3,deleted3,entrancefeest,receiptno1,startdate1,amount1,receiptno2,startdate2,amount2,receiptno3,startdate3,amount3,OLD,CardAmt,MINIMUMUSAGE,CREDITNO,SPOUSEMOBILE,PADD4,CADD4,plotno,societyno,creditstopflag,creditstopdate,MSORDERNO,PrefixMcode,ICNO,UnitNo,RankNo,DateOfCommission,DateOfRelease,DateOfCreation,BTGroup,MDescription,RIDCardNo,ArmService,WO,NoOfDependencies,AnniversaryDate,RByMemberNo,RByMemberNo2,RByName,RByMemberName2,ArmyNo,RankName,BarcodeNo,DependentID,MemberType,MemImage,MemImageSign,SpouseImage,ChildFDob1,Email_Flag,EBill,Wedding_Date,TaxFlag,MLedgerName,F_Mcode,NOMINEE,SDOB,ENC_SMARTCARDNO,MTORDERNO,RAcopyst1,PAcopyst1,BAcopyst1,memlimit) SELECT SequenceNo,TAG,MEMBERTYPECODE,COMPANY,SUBCD,MCODE,MNAME,MID,DOB,DOJ,SEX,MARITALSTATUS,SPOUSE,BG,OCCUPATION,BANKER,BANKACNO,HOBBIES,OTHERINFO,RESIDENT,EQUALIFICATION,PQUALIFICATION,PROPOSER,PROPOSERNAME,SECONDER,SECONDERNAME,PAcopyst,PADD1,PADD2,PADD3,PCITY,PSTATE,PCOUNTRY,PPIN,PPHONE1,PPHONE2,PCELL,PEMAIL,RAcopyst,CADD1,CADD2,CADD3,CCITY,CSTATE,CCOUNTRY,CPIN,CPHONE1,CPHONE2,CCELL,CEMAIL,CONTADD1,CONTADD2,CONTADD3,CONTCITY,CONTSTATE,CONTCOUNTRY,CONTPIN,CONTPHONE1,CONTPHONE2,CONTCELL,CONTEMAIL,EMPTYPE,BUSINESSNAME,BAcopyst,OADD1,OADD2,OADD3,OCITY,OSTATE,OCOUNTRY,OPIN,OPHONE1,OPHONE2,OCELL,OEMAIL,DOEPROFESSION,BUSINESSNATURE,POSITIONHELD,SERVICENAME,SERVICEYEAR,PANO,BBANKER,CCNO,ANNUALINCOME,UPDUSERID,UPDDATETIME,TERMINATION,TRN_CON_DATE,CON_MCODE,PFAX,CFAX,CONTFAX,REASON,PHOTO,CREDITLIMIT,LIMITAMOUNT,WEBSITE,Imagefile,sizefield,Vdate,Vyear,Validdate,TempTermination,TempTermDate,TempTermReason,Memberid,EndingDate,TotalYears,CardNo,CardExpDate,Validity,Period,Creditcardno,CreditExpDt,Type,STATUSDATEFROM,STATUSDATETO,CurentStatus,FirstName,MiddleName,Surname,Alias,Prefix,BillType,Nationality,NationalityAtbirth,Billbasis,BillHead,GDRLocker,LDRLocker,HPLocker,MembershipTo,salut,EntranceFee,DevelopmentFee,CriditNumber,SecurityDeposit,PlaceOfBirth,CountryOfBirth,LastArrivalInCal,PeriodOfStay_year,PeriodOfStay_Month,PreviouslyProposed,NoOfTimesProposed,DateOfProposal,NoOfTimesSeconded,DateOfSeconded,ResultOfProposal,Elected,FatherName,DOBfather,WifeDOB,MaidenNameWife,NationalityWife,WifesFatherName,WifeFatherDOB,ApplNo,ApplDate,Corporatest,CorporateCode,CompName,Designation,ProfessionInfo,BuisnessInfo,Products,AgentsDealers,ESTDdate,NoOfEmp,Turnover,Client,AppliedBut,PositionInChamber,Qulificationstatus,Qualification1,Details1,YearOfPassing1,Institute1,Division1,Qualification2,Details2,YearOfPassing2,Institute2,Division2,Qualification3,Details3,YearOfPassing3,Institute3,Division3,sportstatus,GameType1,NameOfGame1,Description1,GameType2,NameofGame2,Description2,GameType3,NameOfGame3,Description3,Childstatus,ChildName1,ChildDob1,ChildSex1,ChildExpairy1,ChildName2,ChildDob2,ChildSex2,ChildExpairy2,ChildName3,ChildDob3,ChildSex3,childExpairy3,Clubstatus,OtherClubName1,OCAddress1,OCStatus1,OtherClubName2,OCAddress2,OCStatus2,OtherClubname3,OCAddress3,OCStataus,adduser,adddate,freeze,Relativestatus,RelativeName1,Relation1,dateofbirth1,Relativeage1,RelativeSex1,Relativeaddress1,RelativeName2,Relation2,dateofbirth2,Relativeage2,RelativeSex2,Relativeaddress2,RelativeName3,Relation3,dateofbirth3,Relativeage3,RelativeSex3,Relativeaddress3,referentialst,mem_code1,mem_name1,refmem_date1,deleted1,mem_code2,mem_name2,refmem_date2,deleted2,mem_code3,mem_name3,refmem_date3,deleted3,entrancefeest,receiptno1,startdate1,amount1,receiptno2,startdate2,amount2,receiptno3,startdate3,amount3,OLD,CardAmt,MINIMUMUSAGE,CREDITNO,SPOUSEMOBILE,PADD4,CADD4,plotno,societyno,creditstopflag,creditstopdate,MSORDERNO,PrefixMcode,ICNO,UnitNo,RankNo,DateOfCommission,DateOfRelease,DateOfCreation,BTGroup,MDescription,RIDCardNo,ArmService,WO,NoOfDependencies,AnniversaryDate,RByMemberNo,RByMemberNo2,RByName,RByMemberName2,ArmyNo,RankName,BarcodeNo,DependentID,MemberType,MemImage,MemImageSign,SpouseImage,ChildFDob1,Email_Flag,EBill,Wedding_Date,TaxFlag,MLedgerName,F_Mcode,NOMINEE,SDOB,ENC_SMARTCARDNO,MTORDERNO,RAcopyst1,PAcopyst1,BAcopyst1,memlimit FROM membertempdet where mcode='" & Txt_Newmember.Text & "'"
                datalist = gconnection.GetValues(ssql)
    ...
    Private Sub clbal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles clbal.Click
    ...
    Private Sub commembertype_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles commembertype.SelectedIndexChanged

    End Sub

    Private Sub cbo_NewStatus_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_NewStatus.Click

    End Sub

    Private Sub cbo_NewStatus_DropDown(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_NewStatus.DropDown
    ...
    Private Sub commembertype_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles commembertype.KeyDown

    End Sub

    Private Sub commembertype_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles commembertype.KeyPress

    End Sub

    Private Sub commembertype_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles commembertype.Validated

    End Sub

    Private Sub commembertype_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles commembertype.Validating

    End Sub

    Private Sub commembertype_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles commembertype.Click

    End Sub

    Private Sub commembertype_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles commembertype.Enter
