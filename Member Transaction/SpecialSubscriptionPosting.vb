...
Public Class SpecialSubscriptionPosting
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SpecialSubscriptionPosting))
        ...
        Me.dtp_year.Size = New System.Drawing.Size(112, 24)
        ...
        Me.Label2.Text = "SPECIAL FUND POSTING"
        '
        'GroupBox1
        '
        ...
        Me.export.Location = New System.Drawing.Point(560, 16)
        Me.export.Name = "export"
        Me.export.Size = New System.Drawing.Size(112, 32)
        ...
        Me.process.Location = New System.Drawing.Point(32, 440)
        ...
        Me.cancel.Location = New System.Drawing.Point(144, 440)
        ...
        'subsamount
        '
        Me.subsamount.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.ltax.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.ltax.Location = New System.Drawing.Point(744, 542)
        Me.ltax.Name = "ltax"
        Me.ltax.Size = New System.Drawing.Size(81, 17)
        ...
        Me.ltotal.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.ltotal.Location = New System.Drawing.Point(736, 569)
        Me.ltotal.Name = "ltotal"
        Me.ltotal.Size = New System.Drawing.Size(90, 17)
        ...
        Me.lsubs.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.lsubs.Location = New System.Drawing.Point(736, 512)
        Me.lsubs.Name = "lsubs"
        Me.lsubs.Size = New System.Drawing.Size(89, 17)
        ...
        'taxamount
        '
        Me.taxamount.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.SSGRID2.Location = New System.Drawing.Point(0, 24)
        ...
        Me.SSGRID2.TabIndex = 386
        Me.SSGRID2.Visible = False
        '
        'SpecialSubscriptionPosting
        '
        ...
        Me.KeyPreview = True
        Me.Name = "SpecialSubscriptionPosting"
...
#End Region
    ...
    Private Sub Btn_ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_ok.Click
        ...
        Try
            sqlString = " Select Substring(voucherno,6,6)  as Stno from JOURNALENTRY where Substring(voucherno,1,4)='MFUND' order by Substring(voucherno,6,6) "
            ...
            End If
            sqlString = "select isnull(period,'') as period from specialpostingmast "
            sqlString = sqlString & " where postingcode= '" & Trim(cbo_BillingBasis.Text) & "'"
            sqlString = sqlString & " and postingsno=" & Trim(TempString(0))
            posting = gconnection.GetValues(sqlString)

            'sqlString = " Exec  tp_specialsubscriptionview  '" & Format(dtp_year.Value, "dd/MMM/yyyy") & "','" & Trim(cbo_BillingBasis.Text) & "','" & TempString(0) & "',"
            ...
            'sqlString = sqlString & " from SPECIALsubsposting where postingsno=" & TempString(0) & " and billingbasis='" & Trim(cbo_BillingBasis.Text) & "'"
            sqlString = sqlString & " from subsposting where postingsno=" & TempString(0) & " and billingbasis='" & Trim(cbo_BillingBasis.Text) & "'"
            sqlString = sqlString & " and isnull(postingflag,'')<> 'Y' AND " & catecode & " group by mcode,subsacctin,taxcode,period,subsdesc,subcd order by mcode,subsdesc"
            posting = gconnection.GetValues(sqlString)
            If posting.Rows.Count > 1 Then
                ...
                For row = 0 To posting.Rows.Count - 1
                    ...
                    With SSGRID2
                        ...
                        If Len(Trim(Str(Startno))) = 1 Then
                            bill = "MFUND/00000" & Trim(Str(Startno)) & "/" & Trim(Mid(gFinancialyearStart, 8, 2) & "-" & Mid(gFinancialyearEnding, 8, 2))
                        ElseIf Len(Trim(Str(Startno))) = 2 Then
                            bill = "MFUND/0000" & Trim(Str(Startno)) & "/" & Trim(Mid(gFinancialyearStart, 8, 2) & "-" & Mid(gFinancialyearEnding, 8, 2))
                        ElseIf Len(Trim(Str(Startno))) = 3 Then
                            bill = "MFUND/000" & Trim(Str(Startno)) & "/" & Trim(Mid(gFinancialyearStart, 8, 2) & "-" & Mid(gFinancialyearEnding, 8, 2))
                        ElseIf Len(Trim(Str(Startno))) = 4 Then
                            bill = "MFUND/00" & Trim(Str(Startno)) & "/" & Trim(Mid(gFinancialyearStart, 8, 2) & "-" & Mid(gFinancialyearEnding, 8, 2))
                        ElseIf Len(Trim(Str(Startno))) = 5 Then
                            bill = "MFUND/0" & Trim(Str(Startno)) & "/" & Trim(Mid(gFinancialyearStart, 8, 2) & "-" & Mid(gFinancialyearEnding, 8, 2))
                        Else
                            bill = "MFUND/" & Trim(Str(Startno)) & "/" & Trim(Mid(gFinancalyearStart, 8, 2) & "-" & Mid(gFinancialyearEnding, 8, 2))
                        End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Process.Click
        Try
            Dim ssql1 As String
            ssql1 = "SELECT VOUCHERNO,VOUCHERTYPE FROM JOURNALENTRY WHERE VOUCHERTYPE = 'MFUND' AND VOUCHERDATE = '" & Format(dtp_year.Value, "dd/MMM/yyyy") & "'"
            ...
            sqlString = "Exec tp_SPECIALsubscriptionpost '" & Format(dtp_year.Value, "dd/MMM/yyyy") & "','" & Trim(cbo_BillingBasis.Text) & "','" & TempString(0) & "',"
            ...
            sqlString = "Update SPECIALpostingmast set postingflag='Y', postingdate='" & Format(dtp_year.Value, "dd/MMM/yyyy") & "'," & "userid='" & gUsername & "'"
            sqlString = sqlString & " where postingsno='" & TempString(0) & "' and postingcode='" & Trim(cbo_BillingBasis.Text) & "'"
            posting = gconnection.GetValues(sqlString)

            sqlString = "update SPECIALsubsposting set postingflag='Y' "
            sqlString = sqlString & " where postingsno=" & TempString(0) & " and postingcode='" & Trim(cbo_BillingBasis.Text) & "'"
