...
Public Class Class_LocarNo
    ...
    Private Function printdata(ByVal con As String, ByVal SQLSTRING As String, ByVal arraystring() As String, ByVal heading() As String)
        ...
        Try
            ...
            For i = 0 To ds.Tables("Master1").Rows.Count - 1
                ...
                STR4 = IIf((ds.Tables("master1").Rows(i).Item("HPLOCKER")) <> "", (ds.Tables("master1").Rows(i).Item("HPLOCKER")), " - ")

                STR5 = IIf((ds.Tables("master1").Rows(i).Item("GDRLOCKER")) <> "", (ds.Tables("master1").Rows(i).Item("GDRLOCKER")), " - ")
                STR6 = IIf((ds.Tables("master1").Rows(i).Item("LDRLOCKER")) <> "", (ds.Tables("master1").Rows(i).Item("LDRLOCKER")), " - ")

                'Filewrite.WriteLine("{0,-5}{1,-7}{2,-28}{3,-15}{4,-10}{5,-15}", SNO, STR1, STR2, STR3, STR4, STR5)

                Filewrite.WriteLine("{0,-4}{1,-10}{2,-40}{3,-10}{4,-5}{5,-5}{6,-5}{7,1}", "|" & SNO, "|" & STR1, "|" & STR2, "|" & STR3, "|" & STR4, "|" & STR5, "|" & STR6, "|")
    ...
    Private Function HEADER(ByVal STRHEADER() As String, ByVal heading() As String)
        ...
        Try
            ...
            Filewrite.WriteLine("{0,-4}{1,-10}{2,-40}{3,-10}{4,-5}{5,-5}{6,-5}{7,1}", "|SNo", "|CODE", "|NAME", "|STATUS", "|HPL", "|GDRL", "|LDRL", "|")
