...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label6.Location = New System.Drawing.Point(528, 71)
        ...
        Me.tbx_filter_To.Location = New System.Drawing.Point(328, 368)
...
#End Region
    ...
    Private Function printdata11()
        ...
        Try
            ...
            'cmdText = cmdText & " where MEMBERTYPE in (" & txtCategory.Text.Substring(0, txtCategory.Text.Length - 1) & ")and CurentStatus IN('LIVE','ACTIVE') and (RAcopyst1='Y' OR BAcopyst1='Y' OR PAcopyst1='Y') "
            ...
            If dt.Rows.Count > 0 Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    Filewrite.WriteLine(Space(30) & Mid(vMCode(0), 1, 30) & Space(30 - Len(Mid(vMCode(0), 1, 30))) & Space(24) & Mid(vMCode(1), 1, 30) & Space(30 - Len(Mid(vMCode(1), 1, 30))) & Space(24) & Mid(vMCode(2), 1, 30) & Space(30 - Len(Mid(vMCode(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMName(0), 1, 30) & Space(30 - Len(Mid(vMName(0), 1, 30))) & Space(24) & Mid(vMName(1), 1, 30) & Space(30 - Len(Mid(vMName(1), 1, 30))) & Space(24) & Mid(vMName(2), 1, 30) & Space(30 - Len(Mid(vMName(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMAdd1(0), 1, 30) & Space(30 - Len(Mid(vMAdd1(0), 1, 30))) & Space(24) & Mid(vMAdd1(1), 1, 30) & Space(30 - Len(Mid(vMAdd1(1), 1, 30))) & Space(24) & Mid(vMAdd1(2), 1, 30) & Space(30 - Len(Mid(vMAdd1(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMAdd2(0), 1, 30) & Space(30 - Len(Mid(vMAdd2(0), 1, 30))) & Space(24) & Mid(vMAdd2(1), 1, 30) & Space(30 - Len(Mid(vMAdd2(1), 1, 30))) & Space(24) & Mid(vMAdd2(2), 1, 30) & Space(30 - Len(Mid(vMAdd2(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMAdd3(0), 1, 30) & Space(30 - Len(Mid(vMAdd3(0), 1, 30))) & Space(24) & Mid(vMAdd3(1), 1, 30) & Space(30 - Len(Mid(vMAdd3(1), 1, 30))) & Space(24) & Mid(vMAdd3(2), 1, 30) & Space(30 - Len(Mid(vMAdd3(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine(Mid(vMCity(0), 1, 30) & Space(30 - Len(Mid(vMCity(0), 1, 30))) & Space(24) & Mid(vMCity(1), 1, 30) & Space(30 - Len(Mid(vMCity(1), 1, 30))) & Space(24) & Mid(vMCity(2), 1, 30) & Space(30 - Len(Mid(vMCity(2), 1, 30))))
                    pagesize = pagesize + 1
                    Filewrite.WriteLine()
                    Filewrite.WriteLine()
                    'Filewrite.WriteLine()
