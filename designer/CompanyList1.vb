...
#Region "Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(CompanyList1))
        ...
        'fgrdCompanyList
        '
        Me.fgrdCompanyList.Location = New System.Drawing.Point(62, 158)
        ...
        Me.lblAddress1.Size = New System.Drawing.Size(54, 18)
        ...
        Me.lblAddress4.Size = New System.Drawing.Size(53, 18)
        ...
        Me.lblAddress3.Size = New System.Drawing.Size(44, 18)
        ...
        Me.lblAddress2.Size = New System.Drawing.Size(54, 18)
...
#End Region 
    ...
    Private Sub fgrdCompanyList_Click1()
        ...
        If Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0)) <> "" Then
            ...
            SERVICETAXNO = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 8))
            ...
            gFinancialYearEnd = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 2)), "dd/MM/yyyy")
            gFinancalyearStart = Year(gFinancialyearStart)
            'gFinancalYearEnd = Year(gFinancialyearEnding)
            'gFinancalYearEnd = Year(gFinancialyearEnding)
            gDatabase = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 7))
            vCompanyname = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0))
            gCompanyAddress(0) = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0))
            ...
            'MessageBox.Show(gCompanyAddress(2))
            Me.Hide()
            ...
            ''''        sql = "select * FROM Master..CLUBMANVERSION Where ModuleName='" & GModule & "' AND DATEOFVERSION='" & Format(dtLastWriteTime, "dd/MMM/yyyy hh:mm:ss") & "' AND SizeofVersion=" & FileSize
            ''''        gconnection.getDataSet(sql, "FileValidate")
            ''''        If gdataset.Tables("FileValidate").Rows.Count <= 0 Then
            ''''            Dim VersionMaster As New Version_Master
            ''''            VersionMaster.Show()
            ''''        End If
            ''''    End If
            ''''Else
            ...
            Dim mdiacc As New MemberMDI
            mdiacc.Show()
        End If
    End Sub
    Private Sub fgrdCompanyList_Click2()
        Dim MainMenu As Object
        Dim gLogo As Object
        Dim gMainScreen As Object
        Dim FrontConnection As Object
        ...
        If Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0)) <> "" Then
            ...
            gDatabase = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 7))
            vCompanyname = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0))
            'strFinancialYearStart = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 1)), "dd/MM/yyyy")
            'strFinancialYearEnd = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 2)), "dd/MM/yyyy")
    ...
    Private Sub CompanyList1_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        SQLSTRING = SQLSTRING & " ISNULL(ADD1,'') AS ADD1,ISNULL(ADD2,'') AS ADD2,ISNULL(CITY,'') AS CITY,ISNULL(STATE,'') AS STATE,ISNULL(PINCODE,'') AS PINCODE,ISNULL(PHONE1,'') AS PHONE1,ISNULL(FAX,'') AS FAX,ISNULL(TINNO,'')AS TINNO FROM CLUBMASTER where companyname not like '%PAY%' order by sno"
        ...
        If gdataset.Tables("CLUBMASTER").Rows.Count > 0 Then
            ...
            For LoopIndex = 0 To gdataset.Tables("CLUBMASTER").Rows.Count - 1
                With gdataset.Tables("CLUBMASTER").Rows(LoopIndex)
                    ...
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 8, Trim(.Item("TINNO")))
                End With
            Next LoopIndex
        End If
