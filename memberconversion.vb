...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.commembertype.Location = New System.Drawing.Point(184, 144)
        Me.commembertype.Name = "commembertype"
        Me.commembertype.Size = New System.Drawing.Size(232, 21)
        Me.commembertype.TabIndex = 2
        '
        'Label6
        '
...
#End Region
    ...
    Private Sub membertype()
        ...
        Try
            ...
            ssql = "SELECT Membertypecode,Membersubtypecode,Membertype FROM MemberCategoryConversion WHERE Membertypecode='" & oldtypecode & "' AND ISNULL(FREEZE,'') <> 'Y'"
            MEMBERTYPE = gconnection.GetValues(ssql)
            If MEMBERTYPE.Rows.Count > 0 Then
                For I = 0 To (MEMBERTYPE.Rows.Count - 1)
                    commembertype.Items.Add(MEMBERTYPE.Rows(I).Item("Membersubtypecode") & "." & MEMBERTYPE.Rows(I).Item("Membertype"))
                Next
            Else
    ...
    Private Sub cmdadd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdadd.Click
        If cmdadd.Text = "Update[F5]" Then
            ...
            stype3 = stype1(1)
            '============
            ssql = "select membertype from membertype where typedesc='" & stype3 & " '"
            datalist = gconnection.GetValues(ssql)
            If datalist.Rows.Count > 0 Then
            ...
            datalist = gconnection.GetValues(ssql)
            ssql1 = "insert into membertypeconversion(Mcode,OMembertype,CMembertype,Effectfrom,Reason) values('" & txtmembercode.Text & "','" & oldmembertype.Text & "','" & commembertype.Text & "','" & Format(CDate(dtpdate.Text), "yyyy/MM/dd") & "', '" & Cbo_reasons.Text & "')"
