...
Public Class Cry_Debitcredit_MEM
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Debitcredit_MEM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Debitcredit_MEM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Debitcredit_MEM = New Cry_Debitcredit_MEM
        rpt.Site = Me.Site
        Return rpt
    End Function
