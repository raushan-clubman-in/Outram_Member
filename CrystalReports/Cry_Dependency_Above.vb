...
Public Class Cry_Dependency_Above
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Dependency_Above.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Dependency_Above
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Dependency_Above = New Cry_Dependency_Above
        rpt.Site = Me.Site
        Return rpt
    End Function
