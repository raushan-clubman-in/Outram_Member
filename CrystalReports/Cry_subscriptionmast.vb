...
Public Class Cry_subscriptionmast
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_subscriptionmast.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_subscriptionmast
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_subscriptionmast = New Cry_subscriptionmast
        rpt.Site = Me.Site
        Return rpt
    End Function
