...
Public Class Cry_dependent_address
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_dependent_address.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_dependent_address
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_dependent_address = New Cry_dependent_address
        rpt.Site = Me.Site
        Return rpt
    End Function
