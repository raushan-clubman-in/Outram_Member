...
Public Class Cry_Minimum_Usage_AppMember
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Minimum_Usage_AppMember.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Minimum_Usage_AppMember
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Minimum_Usage_AppMember = New Cry_Minimum_Usage_AppMember
        rpt.Site = Me.Site
        Return rpt
    End Function
