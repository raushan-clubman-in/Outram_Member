...
Public Class Month_Bill_Gnc_Summary_
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Month_Bill_Gnc_Summary .rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonth_Bill_Gnc_Summary_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Month_Bill_Gnc_Summary_ = New Month_Bill_Gnc_Summary_
        rpt.Site = Me.Site
        Return rpt
    End Function
