...
Public Class Cry_MEMBER_PORPOSER_SECONDER
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_MEMBER_PORPOSER_SECONDER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MEMBER_PORPOSER_SECONDER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MEMBER_PORPOSER_SECONDER = New Cry_MEMBER_PORPOSER_SECONDER
        rpt.Site = Me.Site
        Return rpt
    End Function
