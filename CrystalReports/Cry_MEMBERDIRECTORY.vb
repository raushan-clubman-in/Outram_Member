...
Public Class Cry_MEMBERDIRECTORY
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_MEMBERDIRECTORY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MEMBERDIRECTORY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MEMBERDIRECTORY = New Cry_MEMBERDIRECTORY
        rpt.Site = Me.Site
        Return rpt
    End Function
