...
Public Class Cry_SubcriptionReceipts
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_SubcriptionReceipts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_SubcriptionReceipts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_SubcriptionReceipts = New Cry_SubcriptionReceipts
        rpt.Site = Me.Site
        Return rpt
    End Function
