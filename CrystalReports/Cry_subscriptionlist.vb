...
Public Class Cry_subscriptionlist
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_subscriptionlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_subscriptionlist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_subscriptionlist = New Cry_subscriptionlist
        rpt.Site = Me.Site
        Return rpt
    End Function
