...
Public Class RPT_monthbilldetail
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RPT_monthbilldetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_monthbilldetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_monthbilldetail = New RPT_monthbilldetail
        rpt.Site = Me.Site
        Return rpt
    End Function
