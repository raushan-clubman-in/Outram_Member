...
Public Class Cry_Dependent_Age_Wise
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Dependent_Age_Wise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Dependent_Age_Wise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Dependent_Age_Wise = New Cry_Dependent_Age_Wise
        rpt.Site = Me.Site
        Return rpt
    End Function
