...
Public Class Cry_qualification_Det
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_qualification_Det.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_qualification_Det
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_qualification_Det = New Cry_qualification_Det
        rpt.Site = Me.Site
        Return rpt
    End Function
