...
Public Class Cry_Member_Status_Det
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Member_Status_Det.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Member_Status_Det
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Member_Status_Det = New Cry_Member_Status_Det
        rpt.Site = Me.Site
        Return rpt
    End Function
