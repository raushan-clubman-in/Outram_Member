...
Public Class Cry_contact_strikers1
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_contact_strikers1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_contact_strikers1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_contact_strikers1 = New Cry_contact_strikers1
        rpt.Site = Me.Site
        Return rpt
    End Function
