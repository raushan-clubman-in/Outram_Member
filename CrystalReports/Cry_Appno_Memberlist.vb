...
Public Class Cry_Appno_Memberlist
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Appno_Memberlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Appno_Memberlist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Appno_Memberlist = New Cry_Appno_Memberlist
        rpt.Site = Me.Site
        Return rpt
    End Function
