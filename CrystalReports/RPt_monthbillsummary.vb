...
Public Class RPt_monthbillsummary
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RPt_monthbillsummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPt_monthbillsummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPt_monthbillsummary = New RPt_monthbillsummary
        rpt.Site = Me.Site
        Return rpt
    End Function
