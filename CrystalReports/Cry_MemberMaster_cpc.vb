...
Public Class Cry_MemberMaster_cpc
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_MemberMaster_cpc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MemberMaster_cpc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MemberMaster_cpc = New Cry_MemberMaster_cpc
        rpt.Site = Me.Site
        Return rpt
    End Function
