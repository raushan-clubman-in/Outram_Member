...
Public Class Cry_Facilit_mem_List1
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Facilit_mem_List1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Facilit_mem_List1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Facilit_mem_List1 = New Cry_Facilit_mem_List1
        rpt.Site = Me.Site
        Return rpt
    End Function
