...
Public Class Cry_Facilit_mem_List
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Facilit_mem_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Facilit_mem_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Facilit_mem_List = New Cry_Facilit_mem_List
        rpt.Site = Me.Site
        Return rpt
    End Function
