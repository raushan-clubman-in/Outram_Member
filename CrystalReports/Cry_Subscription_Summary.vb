...
Public Class Cry_Subscription_Summary
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Subscription_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Subscription_Summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Subscription_Summary = New Cry_Subscription_Summary
        rpt.Site = Me.Site
        Return rpt
    End Function
