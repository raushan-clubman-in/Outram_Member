...
Public Class Cry_AddressList_CONT
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_AddressList_CONT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_AddressList_CONT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_AddressList_CONT = New Cry_AddressList_CONT
        rpt.Site = Me.Site
        Return rpt
    End Function
