...
Public Class Cry_Professional_det
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Professional_det.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Professional_det
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Professional_det = New Cry_Professional_det
        rpt.Site = Me.Site
        Return rpt
    End Function
