...
Public Class Cry_MemberStatusHistory
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_MemberStatusHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MemberStatusHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MemberStatusHistory = New Cry_MemberStatusHistory
        rpt.Site = Me.Site
        Return rpt
    End Function
