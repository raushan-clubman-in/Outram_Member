...
Public Class Cry_CorpStatusSummary
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_CorpStatusSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_CorpStatusSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_CorpStatusSummary = New Cry_CorpStatusSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
