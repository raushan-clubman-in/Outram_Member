...
Public Class Cry_DependencyDetails
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_DependencyDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_DependencyDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_DependencyDetails = New Cry_DependencyDetails
        rpt.Site = Me.Site
        Return rpt
    End Function
