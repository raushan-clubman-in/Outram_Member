...
Public Class Cry_Dependency_below
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Dependency_below.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Dependency_below
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Dependency_below = New Cry_Dependency_below
        rpt.Site = Me.Site
        Return rpt
    End Function
