...
Public Class Cry_MemberMaster_cpc1
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_MemberMaster_cpc1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_MemberMaster_cpc1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_MemberMaster_cpc1 = New Cry_MemberMaster_cpc1
        rpt.Site = Me.Site
        Return rpt
    End Function
