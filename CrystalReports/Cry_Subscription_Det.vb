...
Public Class Cry_Subscription_Det
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_Subscription_Det.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Subscription_Det
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Subscription_Det = New Cry_Subscription_Det
        rpt.Site = Me.Site
        Return rpt
    End Function
