...
Public Class Cry_ArmServicesList
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_ArmServicesList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_ArmServicesList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_ArmServicesList = New Cry_ArmServicesList
        rpt.Site = Me.Site
        Return rpt
    End Function
