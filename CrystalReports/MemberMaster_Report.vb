...
Public Class MemberMaster_Report
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "MemberMaster_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MCode As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedMemberMaster_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MemberMaster_Report = New MemberMaster_Report
        rpt.Site = Me.Site
        Return rpt
    End Function
