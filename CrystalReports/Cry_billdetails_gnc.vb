...
Public Class Cry_billdetails_gnc
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Cry_billdetails_gnc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_billdetails_gnc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_billdetails_gnc = New Cry_billdetails_gnc
        rpt.Site = Me.Site
        Return rpt
    End Function
